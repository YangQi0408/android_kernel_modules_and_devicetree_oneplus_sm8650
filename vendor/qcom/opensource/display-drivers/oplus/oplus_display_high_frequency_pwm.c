...
static void oplus_panel_directional_pwm_switch_tx_cmd(struct dsi_panel *panel,
	...
	SDE_ATRACE_BEGIN("oplus_panel_directional_pwm_switch_tx_cmd");
	if (oplus_panel_pwm_onepulse_is_enabled(panel)) {
		/* on 1 pulse */
	...
	SDE_ATRACE_END("oplus_panel_directional_pwm_switch_tx_cmd");
}
	...
	u32 pwm_switch_cmd)
{
	...
	SDE_ATRACE_BEGIN("oplus_panel_directional_pwm_switch_wait_te_tx_cmd");
	if (pwm_switch_state_before != panel->pwm_params.oplus_pwm_switch_state) {
	...
	SDE_ATRACE_END("oplus_panel_directional_pwm_switch_wait_te_tx_cmd");
	return rc;
}
